...
const handleDownload = () => {
  ...
  return (
    <div className="relative">
      ...
      {/* <!-- Dropdown End --> */}
      <button onClick={handleDownload} className="flex items-center gap-3.5 py-4 px-6 text-sm font-medium duration-300 ease-in-out hover:text-primary lg:text-base">
          <svg
            className="fill-current"
            width="22"
            height="22"
