...
import RoleSettings from './components/roleSetting';
import TableIdOne from './components/TableIdOne';
import UserDetailsPage from './components/TableIdOne';
...
<Routes>
    <Route path="/" element={<SignIn />} />
     <Route path="/getCompanyInfo/:companyName" element={<UserDetailsPage />} />
